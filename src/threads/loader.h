...
/* Some variable for performance monitoring */
extern long long int intr_enter_branches;
extern long long int intr_exit_branches;
extern int set_single_stepping;
unsigned long brLow, brHigh;
#endif
